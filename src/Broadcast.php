...
use Pegziq\WorkWeChat\Messages\BaseMessage;
...
class Broadcast
{
     ...
     * 消息
     *
     * @var \Pegziq\WorkWeChat\Messages\BaseMessage;
     */
    protected $message;
     ...
     * 准备消息
     *
     * @param \Pegziq\WorkWeChat\Messages\BaseMessage $message
     *
     * @return Broadcast
     */
    public function send($message)
    {
        ...
        if (!$message instanceof BaseMessage) {
            throw new \Exception("消息必须继承自 'Pegziq\\WorkWeChat\\BaseMessage'");
        }
